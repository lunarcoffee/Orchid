...
sealed class OrchidToken(private val repr: String) : Token {
    ...
    object Plus : Operator("+", 8, false)
    object Dash : Operator("-", 8, false)
    object Asterisk : Operator("*", 9, false)
    object Slash : Operator("/", 9, false)
    object Percent : Operator("%", 9, false)
    object DoubleAsterisk : Operator("**", 10, true)
